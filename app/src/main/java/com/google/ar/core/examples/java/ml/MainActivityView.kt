...
class MainActivityView(val activity: MainActivity, renderer: AppRenderer) : DefaultLifecycleObserver {
  ...
  // Change these lines to use root.findViewById instead of activity.findViewById
  val distanceTextView = root.findViewById<TextView>(R.id.distanceTextView)
  val safeDistanceMessage = root.findViewById<TextView>(R.id.safeDistanceMessage)
